...
var serverPort = process.env.RTC_PORT || 8084
var serverIpAddress = process.env.RTC_IP || '0.0.0.0'
...
app.use(cors());
var key = fs.readFileSync(path.resolve('encryption/private.key'));
console.log("file 1 read")

var cert = fs.readFileSync( path.resolve('encryption/primary.cert' ));
